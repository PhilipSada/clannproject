                        ...
                        <nav className="second-navigate">
                          ...
                          <div className="second-nav-links-container">
                              <div className="second-nav-links">
                                  ...
                                  <BsChatDots className="react-cool-icons ml-2"/>   
                                  <div className="pl-2"><IoIosNotificationsOutline className="react-cool-icons"/></div> 
                                  <div className="pl-2"><AiOutlineHeart className="react-cool-icons"/></div> 
                                  {
