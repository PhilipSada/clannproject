                           ...
                           <form method="POST" action="/products/{{$product->title}}/bid">
                               ...
                               <div class="row">
                                   ...
                                   <div class="col-sm-6 pl-0">
                                       <p class="text-right">
                                           <button type="submit" class="btn btn-space btn-primary">Bid</button> 
                                       </p>
                                   </div>
                               </div>
                           </form>
         ...
         <div class="row mt-5 d-flex justify-content-center">
            <div class="col-md-8">
                <div class="single-product-text">
                    ...
                    <a href="/contact" class="single-product-contact">Contact the seller</a>
                </div>
            </div>
         </div>
         <div class="row mt-5 d-flex justify-content-center">
                       ...
                       <form method="POST" action="/contact">
                           @csrf
                               ...
                               <div class="form-group">
                                ...
                                required autocomplete="name" placeholder="subject" autofocus >
                                       @error('subject')
                                           <span class="invalid-feedback" role="alert">
                                               <strong>{{ $message }}</strong>
                                           </span>
